...
public class tanker extends SQLiteOpenHelper {

    private static final String Database_path = "/data/data/com.rporopat.relativlayoutjava/databases/";
    private static final String Database_name = "tanker.db";//NAME of database stored in Assets folder
    private static final String Table_name = "tanker";//name of table
    ...
    public tanker(Context context) {//constructor
