...
public class cruiser extends SQLiteOpenHelper {
    private static final String Database_path = "/data/data/com.rporopat.relativlayoutjava/databases/";
    private static final String Database_name = "cruiser.db";//NAME of database stored in Assets folder
    private static final String Table_name = "cruiser";//name of table
    ...
    public cruiser(Context context) {//constructor
