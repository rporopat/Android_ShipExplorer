...
public class Result extends AppCompatActivity {
    ...
    int cor = 0, incorr = 5, attempt = 0, scor = 0, yo = 0;
    int x = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (x1 < 40)
            you.setText("You need to IMPROVE your knowledge of shipbuilding terms");
        else if (x1 < 70)
            you.setText("You are an AVERAGE knower of shipbuilding terms ");
        else if (x1 < 90)
            you.setText("You are an ABOVE AVERAGE knower of shipbuilding terms ");
        else
            you.setText("You are a EXCELLENT knower of shipbuilding terms ");
    }
}
