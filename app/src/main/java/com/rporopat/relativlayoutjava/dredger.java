...
public class dredger extends SQLiteOpenHelper {
    private static final String Database_path = "/data/data/com.rporopat.relativlayoutjava/databases/";
    private static final String Database_name = "dredger.db";//NAME of database stored in Assets folder
    private static final String Table_name = "dredger";//name of table
    ...
    public dredger(Context context) {//constructor
