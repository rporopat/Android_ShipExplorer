...
public class warship extends SQLiteOpenHelper {
    private static final String Database_path = "/data/data/com.rporopat.relativlayoutjava/databases/";
    private static final String Database_name = "warship.db";//NAME of database stored in Assets folder
    private static final String Table_name = "warship";//name of table
    ...
    public warship(Context context) {//constructor
