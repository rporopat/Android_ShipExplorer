...
public class cargo extends SQLiteOpenHelper {
    private static final String Database_path = "/data/data/com.rporopat.relativlayoutjava/databases/";
    private static final String Database_name = "cargo.db";//NAME of database stored in Assets folder
    private static final String Table_name = "cargo";//name of table
    ...
    public cargo(Context context) {//constructor
